...
const config = {
    ...
    behavior: {
        ...
        bannerDelayMobile: 3, // Mobile delay (seconds) - add this line
...
const translations = {
    en: {
        ...
        essentialDesc: "Essential cookies are strictly necessary for the proper functioning of this website and cannot be disabled in our systems. These cookies are fundamental to enabling core features such as secure login, session management, navigation flow, accessibility settings, and overall system integrity. Without these cookies, the site cannot operate as intended and you may encounter degraded performance or unexpected errors.For example, when you log in, essential cookies store your session token so that you do not have to authenticate yourself repeatedly as you navigate through the site. Similarly, when you adjust your privacy settings or set your language preferences, these choices are saved through essential cookie mechanisms. Additionally, security functions such as bot detection, fraud prevention, and access control are also reliant on essential cookies.These cookies do not gather information for marketing purposes nor do they track your activity across other websites or platforms. They are set in response to actions made by you, which amount to a request for services, such as setting privacy preferences, logging in, or filling in forms.Because these cookies are integral to the structure and logic of the website, they are always active and cannot be deselected through our cookie settings. They exist to maintain the foundational performance, reliability, and safety of the digital environment we provide to our visitors. Disabling them in your browser may cause parts of the site to stop functioning entirely. For this reason, consent is not required for these cookies, as they serve the legitimate interest of delivering a secure and functional user experience.",
        analytics: "Analytics Cookies",
        analyticsDesc: "Analytics cookies are employed to collect and analyze information about how visitors interact with our website. These cookies provide invaluable insights into user behavior, which in turn allows us to improve site functionality, content relevance, and overall user satisfaction. By understanding where users come from, how they navigate through the pages, and what actions they take, we can make more informed decisions about optimizing our site structure and experience.For example, analytics cookies can reveal which pages are most frequently visited, how long users spend on a page, or where visitors tend to drop off. This information helps us understand which content performs well and where we need to improve. Furthermore, these cookies allow us to track performance across different devices and browsers, helping to ensure a consistent experience for all visitors.The data collected through analytics cookies is aggregated and anonymized. It is not used to identify individual users, but rather to identify patterns and trends that benefit the broader user base. However, due to the nature of the data analysis tools involved, such as Google Analytics or similar providers, some information may be transmitted to third-party service providers for processing.Although these cookies are not strictly necessary for the website to function, they significantly enhance our ability to deliver a seamless, user-oriented experience. Declining them may result in limited feedback and hinder our ability to improve the website’s usability and effectiveness over time.If you value continuous improvements and tailored content that adapts to user preferences, we strongly recommend enabling analytics cookies. They play a vital role in ensuring the website evolves in line with user needs and expectations.",
        performance: "Performance Cookies",
        performanceDesc: "Performance cookies are designed to enhance the quality, responsiveness, and efficiency of our website by collecting detailed technical information about how it operates in real-world usage scenarios. These cookies do not collect personally identifiable data but instead focus on understanding operational metrics such as page load times, error frequency, latency events, and server response statistics.Their primary function is to help us monitor the technical health and performance of the website so we can identify bottlenecks, fix issues proactively, and improve the infrastructure behind your browsing experience. For example, performance cookies can tell us whether certain features cause slowdowns under specific conditions or whether updates have introduced unintentional bugs.These cookies may also measure the effectiveness of caching strategies, test alternative versions of web pages (A/B testing), and monitor overall uptime and downtime metrics. This ensures that visitors benefit from a reliable and streamlined experience, especially in scenarios involving high traffic, dynamic content rendering, or mobile responsiveness.In some cases, performance cookies also assist with localized content delivery, ensuring users receive faster load times based on their geographical location or network status. This contributes to an overall smoother, more efficient interaction with the site.While performance cookies do not actively track or profile individual visitors, their absence can lead to a lack of visibility into technical issues, which may degrade user satisfaction over time. By enabling these cookies, you are helping us deliver a site that performs consistently at a high standard — for you and for every visitor.Disabling performance cookies does not stop you from using the site, but it limits our ability to optimize it in ways that make your visits faster and more enjoyable.",
        advertising: "Advertising Cookies",
        advertisingDesc: "Advertising cookies are used to make advertising messages more relevant and personalized to you. They perform functions such as preventing the same ad from continuously reappearing, ensuring ads are properly displayed for advertisers, and in some cases, selecting advertisements that are based on your interests.These cookies track browsing habits and activity across websites and services to build a profile of your interests. This profile is then used to serve ads that are tailored to your likely preferences, thereby increasing the relevance of marketing content you see. This targeting can occur both on our site and across the web via third-party advertising networks.For instance, if you browse our site for certain product categories, advertising cookies may ensure that you see related content or offers when visiting other sites later. These cookies are often placed by third-party ad platforms such as Google Ads, Facebook, or programmatic networks and may share data with partners to expand reach and effectiveness.While some users may perceive personalized advertising as intrusive, it is important to note that these cookies play a critical role in helping us fund and maintain the services we offer. Tailored advertising not only provides you with relevant information but also reduces the number of irrelevant ads, enhancing your overall browsing experience.If you choose to disable advertising cookies, you will still see ads, but they may be less relevant to your interests. The volume of ads will not necessarily decrease, but their quality and relevance will. For those who value customized experiences and special offers based on behavior and interests, enabling these cookies is recommended.",
        other: "Other Cookies",
        otherDesc: "Other cookies, also referred to as unclassified or miscellaneous cookies, are those that do not neatly fall into any of the previously defined categories — essential, functional, performance, analytics, or advertising. These cookies may serve a wide range of experimental, auxiliary, or platform-specific functions, and are often deployed during testing phases or in support of new features.They may be set by us or by third-party services embedded on our pages and can include tools for beta features, feedback collection, content experiments, API usage tracking, or integration with third-party platforms not covered under standard advertising or analytics cookies.In some cases, these cookies enable enhancements that are still in the testing or rollout stage — such as previewing new layouts, enabling early access features, or offering limited-time functionality for selected users. Others may support advanced backend infrastructure monitoring or integrations with lesser-known external services that power specific content modules or interactive experiences.Due to their varied nature, these cookies may not always have a fully defined purpose at the time of deployment. As such, they are periodically reviewed and reclassified based on usage trends and technological evolution. We maintain oversight and documentation as their roles become more clearly established.If you opt out of these cookies, it may affect emerging functionalities, experiments, or integrations, which in some cases may reduce your access to advanced features or new interface improvements. While they are not required for the core functionality of the site, they do support innovation and personalized enhancements that some users may find valuable.",
    ...
    <div id="cookieConsentBanner" class="cookie-consent-banner">
        <div class="cookie-consent-container">
            ...
            <div class="main-cookie-consent-content">
                <h2>${lang.title}</h2>
               <p class="broadcookiedes">${lang.description}</p>
